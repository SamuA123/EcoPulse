      ...
      <div className="max-w-4xl flex flex-col gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="flex flex-col items-center mt-4">
            ...
            <p className="text-gray-600 text-center">MODIS Vegetation Index Products (NDVI and EVI) provide global measurements of canopy greenness every 16 days or monthly, at various spatial resolutions (250 m at 0.05°). NASA Goddard Space Flight Center. (n.d.). MODIS Vegetation Index Products (NDVI and EVI). NASA Earth Science Data. https://modis.gsfc.nasa.gov/data/dataprod/mod13.php</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="flex flex-col items-center mt-4">
            <img src="/images/MonitoringSatelital.png" alt="Image 2" className="mb-2 rounded-lg max-w-full h-auto" />
            <p className="text-gray-600 text-center">A comparison of Landsat, MODIS, and VIIRS snow mapping algorithms shows variations in snow cover accuracy under different vegetation conditions (Stillinger et al., 2023). Stillinger, T., Rittger, K., Raleigh, M. S., Michell, A., Davis, R. E., & Bair, E. H. (2023). Landsat, MODIS, and VIIRS snow cover mapping algorithm performance as validated by airborne lidar datasets. [Figure of comparative snow cover maps]. The Cryosphere,. https://doi.org/10.5194/tc-17-567-2023</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="flex flex-col items-center mt-4">
            <img src="/images/DetectionFlowers.png" alt="Image 3" className="mb-2 rounded-lg max-w-full h-auto" />
            <p className="text-gray-600 text-center">Average green-up onset time, image c) 2000s (2001–2009) Zhang, X. Y. (2012). Long-term detection of global vegetation phenology using satellite instruments. In Phenology and Climate Change. IntechOpen. https://doi.org/10.5772/39197</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="flex flex-col items-center mt-4">
            <img src="/images/IndicationsOfClimateChange.png" alt="Image 4" className="mb-2 rounded-lg max-w-full h-auto" />
            <p className="text-gray-600 text-center">Vegetation time series plots and their annual variations. Zhang, X. Y. (2012). Long-term detection of global vegetation phenology using satellite instruments. In Phenology and Climate Change. IntechOpen. https://doi.org/10.5772/39197</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="flex flex-col items-center mt-4">
            <img src="/images/AplicationsEcologicalsandSocials.png" alt="Image 5" className="mb-2 rounded-lg max-w-full h-auto" />
            <p className="text-gray-600 text-center">They show the use of NDVI (vegetation index) series to determine the best planting and harvesting times. Gao, F., Anderson, M. C., Zhang, X., Yang, Z., Alfieri, J. G., Kustas, W. P., ... & Johnson, D. M. (2021). Mapping crop phenology in near real-time using satellite remote sensing. Science Partner Journal: Remote Sensing, 3, 8379391. https://doi.org/10.34133/2021/8379391</p>
          </div>
        </div>
